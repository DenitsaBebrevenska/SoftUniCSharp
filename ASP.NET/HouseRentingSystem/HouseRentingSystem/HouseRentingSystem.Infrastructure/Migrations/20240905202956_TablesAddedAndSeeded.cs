        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, comment: "House brief description"),
                    ImageUrl = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: false, comment: "House brief description"),
                    PricePerMonth = table.Column<decimal>(type: "decimal(6,2)", nullable: false, comment: "Price per month for the house rental"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Category identifier"),
                    AgentId = table.Column<int>(type: "int", nullable: false, comment: "Agent identifier"),
                    RenterId = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "The user`s identifier who rents the house")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "6d5800ce-d726-4fc8-83d9-d6b3ac1f591e", 0, "53ca83a2-7e77-435a-a87a-8b77e0703177", "guest@mail.com", false, false, null, "guest@mail.com", "guest@mail.com", "AQAAAAEAACcQAAAAEPcOrNOQHZCO6VQkWwJvc0HezaIrvTCpbRxAansCBQbzX1LmotBv85xqoC7ZQfozOw==", null, false, "53f1db4c-103d-4bbb-9a21-20a7004652e4", false, "guest@mail.com" },
                    { "dea12856-c198-4129-b3f3-b893d8395082", 0, "036ef3f6-c9ee-48df-98a6-f8a5bc4abf93", "agent@mail.com", false, false, null, "agent@mail.com", "agent@mail.com", "AQAAAAEAACcQAAAAEG4AGjoE4GoHB/xUnclQsXocP94ZvOxafqtyaAGvty2vY2uIYJgau6Ka5u5/vXSK7g==", null, false, "517a3a94-5aca-45e2-9ca6-dc6abe7d7dfb", false, "agent@mail.com" }
                });
