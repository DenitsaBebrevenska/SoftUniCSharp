        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "Task date and time creation"),
                    BoardId = table.Column<int>(type: "int", nullable: true, comment: "Board identifier of to which the task belongs"),
                    OwnerId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Owner/creator identifier of the task")
                },
                constraints: table =>
                {
